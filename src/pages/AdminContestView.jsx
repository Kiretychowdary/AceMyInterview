      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm font-medium mb-2">Total Registrations</p>
              <p className="text-4xl font-bold text-blue-600">{stats.totalRegistrations}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm font-medium mb-2">Active Now</p>
              <p className="text-4xl font-bold text-green-600">{stats.activeNow}</p>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm font-medium mb-2">Total Problems</p>
              <p className="text-4xl font-bold text-purple-600">{stats.problemsCount}</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-600 text-sm font-medium mb-2">Submissions</p>
              <p className="text-4xl font-bold text-orange-600">{stats.submissions}</p>
            </div>
